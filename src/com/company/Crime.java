...
public class Crime {
    ...
    public Crime(String cDateTime, String address, Integer district, String beat, Integer grid, String crimeDescr, Integer ucrNcicCode, Float latitude, Float longtitude) {
